/*
  ...
  - Added the required column `soin_id` to the `rendez_vous` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_rendez_vous" (
    ...
    CONSTRAINT "rendez_vous_soin_id_fkey" FOREIGN KEY ("soin_id") REFERENCES "bien" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);

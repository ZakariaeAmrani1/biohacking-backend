...
INSERT INTO "new_Client" ("CIN", "Cree_par", "adresse", "allergies", "antecedents", "commentaire", "created_at", "date_naissance", "email", "groupe_sanguin", "id", "nom", "numero_telephone", "prenom") SELECT "CIN", "Cree_par", "adresse", "allergies", "antecedents", "commentaire", "created_at", "date_naissance", "email", "groupe_sanguin", "id", "nom", "numero_telephone", "prenom" FROM "Client";
DROP TABLE "Client";
...
INSERT INTO "new_Utilisateur" ("CIN", "adresse", "created_at", "date_naissance", "email", "id", "nom", "numero_telephone", "password", "prenom", "role") SELECT "CIN", "adresse", "created_at", "date_naissance", "email", "id", "nom", "numero_telephone", "password", "prenom", "role" FROM "Utilisateur";
...
INSERT INTO "new_bien" ("Cree_par", "Nom", "Type", "bien_type", "cabinet", "created_at", "id", "prix", "stock") SELECT "Cree_par", "Nom", "Type", "bien_type", "cabinet", "created_at", "id", "prix", "stock" FROM "bien";
DROP TABLE "bien";
...
INSERT INTO "new_facture" ("CIN", "Cree_par", "created_at", "date", "id", "notes", "prix_total", "statut") SELECT "CIN", "Cree_par", "created_at", "date", "id", "notes", "prix_total", "statut" FROM "facture";
DROP TABLE "facture";
...
INSERT INTO "new_facture_bien" ("Cree_par", "created_at", "id", "id_bien", "id_facture", "quantite", "type_bien") SELECT "Cree_par", "created_at", "id", "id_bien", "id_facture", "quantite", "type_bien" FROM "facture_bien";
...
INSERT INTO "new_paiment" ("Cree_par", "created_at", "date", "id", "id_facture", "montant_totale") SELECT "Cree_par", "created_at", "date", "id", "id_facture", "montant_totale" FROM "paiment";
DROP TABLE "paiment";
...
INSERT INTO "new_rendez_vous" ("CIN", "Cree_par", "cabinet", "created_at", "date_rendez_vous", "id", "status", "sujet") SELECT "CIN", "Cree_par", "cabinet", "created_at", "date_rendez_vous", "id", "status", "sujet" FROM "rendez_vous";

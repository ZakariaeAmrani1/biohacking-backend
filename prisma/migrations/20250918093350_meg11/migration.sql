...
INSERT INTO "new_facture" ("CIN", "Cree_par", "cheque_banque", "cheque_date_tirage", "cheque_numero", "created_at", "date", "date_paiement", "id", "methode_paiment", "notes", "prix_total", "statut", "updated_at") SELECT "CIN", "Cree_par", "cheque_banque", "cheque_date_tirage", "cheque_numero", "created_at", "date", "date_paiement", "id", "methode_paiment", "notes", "prix_total", "statut", "updated_at" FROM "facture";
DROP TABLE "facture";
